  ...
  return (
    ...
    >
      <header className="d-flex justify-content-between align-items-center">
        ...
        >
          <OnHoverClose className="p-2 d-flex justify-content-center align-items-center rounded-5">
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
              width="20px"
        ...
        <div style={{ height: 32, width: 20 }} />
      </header>

      <section style={{ width: 300 }} className="mt-4 m-auto  d-grid gap-4">
        ...
        <Form onSubmit={handleSubmit(submitForm)} className="d-grid gap-2 ">
          ...
          <div>
            <span style={{ color: "rgb(83, 100, 113)" }} className="">
