    ...
    <div>
      <Wrapper className="px-3">
        <Author className="my-2">
          ...
          <NameSection>
            <NameWrapper>
              <Username className="pl-2 fw-bold">Ярослав Львівський</Username>
        ...
        <Date className="border-bottom py-3 fw-bold bg-light">
          10:00 AM · 10 сер. 2022 р. - Leleka Web App
        </Date>
        <Statistic className="border-bottom py-3 bg-light">
          <span className="fw-bold text-dark pe-1">1 215</span>
          <span className="text-dark pe-3">рекурликів</span>
          <span className="fw-bold text-dark pe-1">44</span>
          <span className="text-dark pe-3">курлика с цитатами</span>
          <span className="fw-bold text-dark pe-1">11,8 тис.</span>
          <span className="text-dark pe-3">відміток «Подобається»</span>
        </Statistic>
        <IconsBar className="border-bottom py-1 mx-0 bg-light row justify-content-around">
          <IconBg
            iconBgColor={bgBlue}
            className="m-0 p-0 rounded-circle row align-items-center justify-content-center"
          >
            <Icon fillColor={Blue} className="p-0 m-0">
          ...
          <IconBg
            ...
            className="m-0 p-0 rounded-circle row align-items-center justify-content-center"
          >
            <Icon fillColor={Green} className="p-0 m-0">
              <svg viewBox="0 0 24 24" aria-hidden="true">
                <g>
          ...
          <IconBg
            ...
            className="m-0 p-0 rounded-circle row align-items-center justify-content-center"
          >
            <Icon fillColor={Red} className="p-0 m-0">
              <svg viewBox="0 0 24 24" aria-hidden="true">
                <g>
